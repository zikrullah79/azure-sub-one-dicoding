        ...
        <table class="table table-condensed">
            ...
            <?php 
                do{
                    ...
                    {
                        echo "<tr><td>".$blob->getName()."</td><td><form  method='POST' action='analyze.php'>
                        <input name='submit' type ='submit' value='analyze'></input><input type='hidden' name='img' value = '".$blob->getUrl()."'/></form></td></tr>";
                    }
